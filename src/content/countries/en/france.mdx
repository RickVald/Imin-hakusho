...
<ComingSoon label="Pension-system participation and dependency data broken down by migration status are not published in France, due to the legal prohibition on origin-based statistics (loi Informatique et Libertés). No official disaggregated data available." />
