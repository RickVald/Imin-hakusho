...
<ComingSoon label="A complete decade-by-decade time series of the foreign-national population share from the 1960s to 2025 (Statistik Austria, 'Historische Volkszählungen' data tables) is planned for a future update." />
...
<ComingSoon label="A detailed age-structure breakdown (shares within the 0-17, 18-39, 40-64, and 65+ age bands, separately for the Austrian-origin and migration-background populations) is planned for a future update, pending direct review of Statistik Austria's 'Tabellensammlung Migrationshintergrund' (.ods format)." />
...
The origin breakdown by nationality group (section 3.2) appears to exist in Statistik Austria's STATatlas/STATcube tools, but this research could not extract exact percentages from the primary source in text form, hence the ComingSoon placeholder.
</div>
