...
- The CSO maintains a tracking infrastructure (Educational Longitudinal Database, ELD) that records students' nationality via the Programme and Learner Support System (PLSS). In 2017, 27,454 PLC (Post-Leaving Certificate) learners came from more than 119 different nationalities. Source: CSO, *Educational Longitudinal Database (ELD)*
...
- The Irish housing crisis was already severe before the recent rise in migration — correlation and causation must be clearly distinguished.
