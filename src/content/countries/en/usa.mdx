...
<ComingSoon label="Intermediate data points for 1930–1960, and precise decade-by-decade flow totals based on the DHS Yearbook of Immigration Statistics (Table 1, Lawful Permanent Residents), are planned for a future update." />
...
<ComingSoon label="An age pyramid by region of origin (age bands 0-17 / 18-64 / 65+, drawing on ACS table S0501) is planned for a future update — this research could not extract verified age-band figures directly from the data portal." />

### 3.5 Long-term projection

<ComingSoon label="Census Bureau long-term population projections broken down by nativity (foreign-born / US-born) are planned for a future update." />
...
<ComingSoon label="A demographic dependency ratio (pensioners and children relative to working-age population) broken down by nativity is planned for a future update." />
...
<ComingSoon label="Precise score gap (reading/mathematics) between EL and non-EL students for the most recent year is planned for a future update — the NAEP Data Explorer requires interactive manual extraction and could not be confirmed during this research." />
...
<ComingSoon label="A single, public summary figure on the share of immigrants in social/assisted housing in the United States is planned for a future update. A regulatory note to keep in mind: most immigrants in irregular status are in any case ineligible for federal social housing." />
