...
No official statistic directly comparing the age structure of the New Zealand-born and overseas-born populations is available in a pre-aggregated form. The 2023 Census reports an overall median age of 38.1 years (up from 37.4 in 2018). Stats NZ's "Interactive population pyramid" tool (https://www.stats.govt.nz/tools/interactive-population-pyramid-for-new-zealand/) may support a birthplace breakdown.
</div>
